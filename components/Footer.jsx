...
const Footer = () => {
  ...
  return (
    <section className='md:min-h-[600px] ss:min-h-[450px] min-h-[450px] 
    flex items-center bg-white sm:px-16 px-6'>
        ...
        flex-col justify-center font-manierRegular max-w-[95rem]'>
            ...
            className='flex md:mt-5 ss:mt-4 mt-4 items-center'>
                <BiCopyright className='sm:mr-1 mr-1 md:text-[16px] 
                ss:text-[18px] text-[15px] mt-1 text-maintext' />

                <p className='md:text-[16px] ss:text-[16px] text-[13px] 
                text-maintext mt-1'>
            ...
            <motion.div variants={fadeIn('down', 'spring', 0.3)}
            className='flex md:mt-8 ss:mt-5 mt-5 items-center flex-col'>
                    ...
                    {footerLinks.map((footer, index) => (
                        <ul className='list-none' key={footer.name}>
                            ...
                            >
                                ...
                                text-[13px] text-maintext hover:text-secondary 
            ...
            <motion.div variants={fadeIn('down', 'spring', 0.3)}
            className='borderTop pt-5 md:mt-10 ss:mt-8 mt-8 
